...
Face['zhao_nan'] = 'fc6c893cb562848d17e8af61bb4d1b92'
Face['wang_wei'] = 'fedf06fb3eaa9a28ea9d52bbed51146b'
        ...
        if len(ret2) != 0:
            ...
            for k, v in Face.iteritems():
                if v == search_result['results'][0]['face_token']:
                    conf = float(search_result['results'][0]['confidence'])
                    if conf >= 65.5:
                        print 'hello,', k
                        print '=' * 60
                        break
                    print search_result['results'][0]['confidence'], 'like', k
    #time.sleep(1)
